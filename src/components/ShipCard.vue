        ...
        <div class="card bg-dark text-white">
          <div class="card-header">
            <div class="row">
                ...
                <div class="col">
                    <span class="material-icons">oil_barrel</span> {{ ship.fuel.current }} / {{ ship.fuel.capacity }}
                </div>
            </div>
          </div>
          <div class="card-body">
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row">                            
                            <div class="col"><span class="material-icons">oil_barrel</span> {{ ship.fuel.consumed.amount }}</div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col">
                                <span class="material-icons">groups</span> {{ ship.crew.current }} / {{ ship.crew.required }} / {{ ship.crew.capacity }}
                            </div>
